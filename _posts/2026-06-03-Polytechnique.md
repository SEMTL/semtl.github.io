...
A meeting of the SEMTL community will be held on **Thursday, June 3rd, 2026, starting at 09:00**. It will take place at **M-101, 1st floor of Pavilions Lassonde** at **Polytechnique Montréal**. Coffee and pastries will be available during the meeting.
...
Please RSVP using [Eventbrite](https://www.eventbrite.ca/e/semla-2026-tickets-1986545274392), using the discount code provided in an email. This is free and used to organize logistics.

### Program

* 09:00 to 12:30:
  * Please see [https://semla.polymtl.ca/program-overview/](https://semla.polymtl.ca/program-overview/) for the program

* 12:30 - Social event
  * For the social event, we will eat lunch with all SEMLA attendees
  * If you have a *paid registration* for SEMLA, then lunch is provided.
...
Easily accessible from the _Université de Montréal_ station on the blue metro line.
